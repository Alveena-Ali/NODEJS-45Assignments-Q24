...
console.log("Inequality Test with strings:", ("Apple" as string) === "Orange"); // False
...
console.log("Inequality Test with numbers:", (26 as number) != 35); // True
...
//   Test No 12:
// • Test whether an item is in a array
const fruits: string[] = ['Banana' , 'Mango' , 'Orange'];
